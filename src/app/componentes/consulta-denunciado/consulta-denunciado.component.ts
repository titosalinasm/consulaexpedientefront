...
@Component({
  selector: 'app-consulta-denunciado',
  templateUrl: './consulta-denunciado.component.html',
  styleUrls: ['./consulta-denunciado.component.css']
})
export class ConsultaDenunciadoComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
    ...
    private expedientexdenunciadoService: ExpedientexdenunciadoService,
  ...
  this.denunciadoService.getWithPost$(this.objParam).subscribe(
    resp => {
      this._spinner.hide();
  ...
  this.expedientexdenunciadoService.getWithPost$(param).subscribe(
    resp => {
